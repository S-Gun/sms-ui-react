    ...
    return (
        ...
        <Container fluid>
            ...
            <Nav
                ...
                <Nav.Link href="/">Bin{' '}<Badge bg="secondary">10</Badge></Nav.Link>
                <Nav.Link href="/">Draft{' '}<Badge bg="secondary">0</Badge></Nav.Link>
                <Nav.Link href="/">Outbox{' '}<Badge bg="secondary">0</Badge></Nav.Link>
            </Nav>
